...
The release workflow validates the tag against the manifest, builds the package, and publishes files from `dist/GameplayConfigSync/`. Steam Workshop upload remains a manual in-game step.
